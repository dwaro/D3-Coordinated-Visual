...
(function(){
    ...
    function createDropdown(csvData){
        ...
        var dropdown = d3.select("body")
            ...
            .on("change", function(){
                ...
                updateDomain(this.value, csvData)
            });
    ...
    function updateChart(bars, n, colorScale){
        ...
        .attr("height", function(d, i){
            ...
            return 463 - yScale(parseFloat(d[expressed])); // 443
        })
        .attr("y", function(d, i){
            return yScale(parseFloat(d[expressed])) + topBottomPadding; // +20
        })
        //color/recolor bars
        .style("fill", function(d){
